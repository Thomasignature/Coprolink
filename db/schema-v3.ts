...
export const inboundEmails = pgTable("inbound_emails", {
  ...
  documentActionStatus: text("document_action_status").notNull().default("pending"),
  documentIdsJson: text("document_ids_json").notNull().default("[]"),
  documentActionedAt: timestamp("document_actioned_at"),
  ticketActionStatus: text("ticket_action_status").notNull().default("pending"),
  ticketReference: text("ticket_reference").notNull().default(""),
  ticketActionedAt: timestamp("ticket_actioned_at"),
  announcementActionStatus: text("announcement_action_status").notNull().default("pending"),
  announcementId: integer("announcement_id"),
  announcementActionedAt: timestamp("announcement_actioned_at"),
