      ...
      <aside className="v2-sidebar">
        ...
        <div className="v2-sidebar-bottom">
          ...
          <div className="v2-user-card">
            ...
            <div><strong>{session.user.fullName || session.user.email}</strong><small>Espace syndic</small></div>
          </div>
  ...
  return (
    <div className="release-page">
      <div className="release-grid">
        <section className="release-card wide"><div className="release-card-head"><div><span>DÉMARRAGE RAPIDE</span><h3>Onboarder une copropriété</h3></div><HelpCircle /></div><div className="release-help-steps"><div className="release-help-step"><b>1</b><strong>Renseigner les lots et personnes</strong><p>Le syndic constitue la base administrative de l’immeuble : lots, copropriétaires, bailleurs, occupants et locataires.</p></div><div className="release-help-step"><b>2</b><strong>Activer les accès</strong><p>Ajoutez les e-mails puis invitez les personnes concernées. Les comptes restent séparés des données administratives.</p></div><div className="release-help-step"><b>3</b><strong>Désigner les référents</strong><p>Les référents assurent la gouvernance et la continuité de CoproLink sans remplacer le syndic pour l’encodage administratif.</p></div></div></section>
        <section className="release-card"><div className="release-card-head"><div><span>FAQ</span><h3>Questions fréquentes</h3></div><Info /></div><div className="release-faq"><details><summary>Qui alimente les données de l’immeuble ?</summary><p>Le syndic est l’opérateur administratif : il renseigne les lots, les personnes et les accès. Les Référents CoproLink disposent d’une vue de gouvernance et assurent la continuité de l’espace de l’immeuble.</p></details><details><summary>Une personne doit-elle avoir un compte ?</summary><p>Non. Une personne peut exister dans l’annuaire sans accès numérique. L’invitation est une action séparée.</p></details><details><summary>Les données disparaissent-elles après un refresh ?</summary><p>Non. Les données métier de l’immeuble sont enregistrées dans la base persistante.</p></details></div></section>
